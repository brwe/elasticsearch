    ...
    public String getFinalPath(Map<String, String> pathParams) {
        ...
        for (Map.Entry<String, String> paramEntry : matchingRestPath.params.entrySet()) {
            ...
            if (value == null) {
                ...
                // TODO: Figure out if it is possible that two paths acept same
                ...
                // randomize?
                throw new IllegalArgumentException("parameter [" + paramEntry.getValue() + "] missing, path [" + path
                        + "] contains placeholders that weren't replaced with proper values");
            } else {
