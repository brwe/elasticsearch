...
public class CustomScoreSearchTests extends AbstractSharedClusterTest {
    ...
    public void testTriggerBooleanScorer_withFunctionScore() throws Exception {
        ...
        client().admin().indices().prepareRefresh().execute().actionGet();
        SearchResponse searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(fuzzyQuery("field", "value")).add(FilterBuilders.idsFilter("type").addIds("1"), new CustomBoostFactorBuilder().boostFactor( 3)))
                .execute().actionGet();
        assertThat(Arrays.toString(searchResponse.getShardFailures()), searchResponse.getFailedShards(), equalTo(0));
    ...
    public void testCustomFiltersScore_withFunctionScore() throws Exception {
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(matchAllQuery()).add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value2"), new CustomBoostFactorBuilder().boostFactor( 3)))
                .setExplain(true)
                .execute().actionGet();
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(matchAllQuery()).scoreMode("total").add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value1"), new CustomBoostFactorBuilder().boostFactor( 3)).add(termFilter("color", "red"), new CustomBoostFactorBuilder().boostFactor( 5)))
                .setExplain(true)
                .execute().actionGet();
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(matchAllQuery()).scoreMode("max").add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value1"), new CustomBoostFactorBuilder().boostFactor( 3)).add(termFilter("color", "red"), new CustomBoostFactorBuilder().boostFactor( 5)))
                .setExplain(true)
                .execute().actionGet();
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(matchAllQuery()).scoreMode("avg").add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value1"), new CustomBoostFactorBuilder().boostFactor( 3)).add(termFilter("color", "red"), new CustomBoostFactorBuilder().boostFactor( 5)))
                .setExplain(true)
                .execute().actionGet();
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(matchAllQuery()).scoreMode("min").add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value1"), new CustomBoostFactorBuilder().boostFactor( 3)).add(termFilter("color", "red"), new CustomBoostFactorBuilder().boostFactor( 5)))
                .setExplain(true)
                .execute().actionGet();
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(matchAllQuery()).scoreMode("multiply").add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value1"), new CustomBoostFactorBuilder().boostFactor( 3)).add(termFilter("color", "red"), new CustomBoostFactorBuilder().boostFactor( 5)))
                .setExplain(true)
                .execute().actionGet();
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(termsQuery("field", "value1", "value2", "value3", "value4")).scoreMode("first").add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value3"), new CustomBoostFactorBuilder().boostFactor( 3)).add(termFilter("field", "value2"), new CustomBoostFactorBuilder().boostFactor( 4)))
                .setExplain(true)
                .execute().actionGet();
        ...
        searchResponse = client().prepareSearch("test")
                .setQuery(functionScoreQuery(termsQuery("field", "value1", "value2", "value3", "value4")).scoreMode("multiply").add(termFilter("field", "value4"), new CustomBoostFactorBuilder().boostFactor( 2)).add(termFilter("field", "value1"), new CustomBoostFactorBuilder().boostFactor( 3)).add(termFilter("color", "red"), new CustomBoostFactorBuilder().boostFactor( 5)))
                .setExplain(true)
                .execute().actionGet();
