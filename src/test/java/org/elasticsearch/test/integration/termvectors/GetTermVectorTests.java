...
public class GetTermVectorTests extends AbstractSharedClusterTest {
    ...
    public void streamTest() throws Exception {
        ...
        outResponse.setDocumentExists(true);
        ...
        inResponse.readFrom(esBuffer);
        assertTrue(inResponse.getDocumentExists());
    ...
    public void testNoSuchDoc() throws Exception {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            assertThat(actionGet.getDocumentExists(), Matchers.equalTo(false));
    ...
    public void testExistingFieldWithNoTermVectorsNoNPE() throws Exception {
        ...
        TermVectorResponse actionGet = termVector.actionGet();
        assertThat(actionGet.getDocumentExists(), Matchers.equalTo(true));
    ...
    public void testSimpleTermVectors() throws ElasticSearchException, IOException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            assertThat("doc id: " + i + " doesn't exists but should", response.getDocumentExists(), equalTo(true));
    ...
    public void testRandomSingleTermVectors() throws ElasticSearchException, IOException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            TermVectorResponse response = resp.execute().actionGet();
            assertThat(infoString + "doc id: " + i + " doesn't exists but should", response.getDocumentExists(), equalTo(true));
            Fields fields = response.getFields();
