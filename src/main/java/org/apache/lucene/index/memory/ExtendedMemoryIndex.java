        ...
        try {
            ...
            if (!fieldInfos.containsKey(fieldName)) {
                fieldInfos.put(fieldName,
                        new FieldInfo(fieldName, true, fieldInfos.size(), false, false, false, this.storeOffsets ? FieldInfo.IndexOptions.DOCS_AND_FREQS_AND_POSITIONS_AND_OFFSETS : FieldInfo.IndexOptions.DOCS_AND_FREQS_AND_POSITIONS , null, null, null));
            }
    ...
    private final class MemoryIndexReader extends AtomicReader {
        ...
        private class MemoryDocsAndPositionsEnum extends DocsAndPositionsEnum {
            ...
            public MemoryDocsAndPositionsEnum() {
                this.sliceReader = new IntBlockPool.SliceReader(intBlockPool);
            }
