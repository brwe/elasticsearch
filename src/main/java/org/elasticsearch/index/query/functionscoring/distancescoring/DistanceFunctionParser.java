...
public abstract class DistanceFunctionParser implements ScoreFunctionParser {
    ...
    private ScoreFunction parseNumberVariable(String fieldName, XContentParser parser, QueryParseContext parseContext,
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            ...
            } else if (parameterName.equals(DistanceFunctionBuilder.SCALE)) {
                scaleString = parser.text();
            } else if (parameterName.equals(DistanceFunctionBuilder.SCALE_WEIGHT)) {
                scaleWeight = parser.doubleValue();
            } else if (parameterName.equals(DistanceFunctionBuilder.REFERNECE)) {
