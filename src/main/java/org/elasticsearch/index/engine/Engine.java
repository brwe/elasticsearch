...
public interface Engine extends Closeable {
    ...
    static abstract class IndexingOperation implements Operation {
        ...
        public IndexingOperation(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, Origin origin, long startTime, boolean isRetry) {
        ...
        public IndexingOperation(DocumentMapper docMapper, Term uid, ParsedDocument doc, boolean isRetry) {
            this(docMapper, uid, doc, Versions.MATCH_ANY, VersionType.INTERNAL, Origin.PRIMARY, System.nanoTime(), isRetry);
        }
    ...
    static final class Create extends IndexingOperation {
        ...
        public Create(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, Origin origin, long startTime, boolean isRetry) {
            super(docMapper, uid, doc, version, versionType, origin, startTime, isRetry);
        }

        public Create(DocumentMapper docMapper, Term uid, ParsedDocument doc, boolean isRetry) {
            super(docMapper, uid, doc, isRetry);
        }
    ...
    static final class Index extends IndexingOperation {
        ...
        public Index(DocumentMapper docMapper, Term uid, ParsedDocument doc, long version, VersionType versionType, Origin origin, long startTime, boolean isRetry) {
            super(docMapper, uid, doc, version, versionType, origin, startTime, isRetry);
        }


        public Index(DocumentMapper docMapper, Term uid, ParsedDocument doc, boolean isRetry) {
            super(docMapper, uid, doc, isRetry);
        }
