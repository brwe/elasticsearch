 ...
 *
 */
public class IndexShard extends AbstractIndexShardComponent implements RefCounted {
    ...
    private final SealCounter sealCounter = new SealCounter(IN_FLIGHT_OPERATIONS_COUNTER);
    ...
    private class SealCounter extends AbstractRefCounted {

        SealCounter(String name) {
            super(name);
        }
    ...
    private void seal() {
        // TODO: here seal the shard, whatever this means
    }
