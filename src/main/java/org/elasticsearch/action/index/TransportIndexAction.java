    ...
    protected Tuple<IndexResponse, IndexRequest> shardOperationOnPrimary(ClusterState clusterState, PrimaryOperationRequest shardRequest) {
        ...
        if (request.opType() == IndexRequest.OpType.INDEX) {
            ...
            if (index.parsedDoc().mappingsModified()) {
                logger.debug("update mapping on master {}", index.docMapper().refreshSource().toString());
            ...
            if (create.parsedDoc().mappingsModified()) {
                logger.debug("update mapping on master {}", create.docMapper().refreshSource().toString());
