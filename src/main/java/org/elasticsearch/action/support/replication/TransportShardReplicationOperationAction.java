...
public abstract class TransportShardReplicationOperationAction<Request extends ShardReplicationOperationRequest, ReplicaRequest extends ShardReplicationOperationRequest, Response extends ActionWriteResponse, ReplicaResponse extends TransportResponse> extends TransportAction<Request, Response> {
    ...
    protected TransportShardReplicationOperationAction(Settings settings, String actionName, TransportService transportService,
        ...
        transportService.registerHandler(transportReplicaAction, getReplicaOperationTransportHandler());
    ...
    protected ReplicaOperationTransportHandler getReplicaOperationTransportHandler() {
        return new ReplicaOperationTransportHandler();
    }
