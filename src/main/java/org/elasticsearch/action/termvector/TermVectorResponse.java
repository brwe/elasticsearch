...
public class TermVectorResponse extends ActionResponse implements ToXContent {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        final boolean docExists = getDocumentExists();
    ...
    public Fields getFields() throws IOException {
        if (hasTermVectors() && getDocumentExists()) {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(FieldStrings.EXISTS, getDocumentExists());
    ...
    public void setDocumentExists(boolean exists) {
         this.exists = exists;
    }
